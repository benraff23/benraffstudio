...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://benraffstudio.com/politique-de-confidentialite' },
}
  ...
  return (
    <div className="min-h-screen bg-[#1e1e1e] text-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-20">
        <p className="text-xs font-medium tracking-[0.15em] uppercase text-[#f7f5f1] mb-4">Vos droits &amp; vos données</p>
        ...
        <div className="flex flex-col gap-14 text-[#b8b8b8] leading-relaxed">
          ...
          <section>
            ...
            <ul className="flex flex-col gap-2 text-sm list-disc list-inside marker:text-[#9a9a9a]">
            ...
            <div className="bg-black/[0.03] border border-white/[0.06] rounded-xl p-5 text-sm">
              ...
              <ul className="flex flex-col gap-2 text-[#9a9a9a]">
                <li className="flex gap-3">
                  <span className="text-[#f7f5f1] flex-shrink-0">→</span>
          ...
          <section>
            ...
            <p className="text-sm mt-4">
              ...
              <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-[#f7f5f1] hover:underline">
                CNIL (cnil.fr)
              </a>.
            </p>
          </section>
