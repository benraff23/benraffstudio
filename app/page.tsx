...
function Contact() {
  return (
    <section id="contact" style={{ background: '#111111' }} className="py-24 sm:py-32" aria-label="contact">
      <div className="max-w-[1400px] mx-auto px-[var(--gutter)]">
        <div className="grid lg:grid-cols-[5fr_7fr] gap-16 lg:gap-24 items-start">
          ...
          <div className="reveal-right bg-[#1e1e1e] border border-white/[0.06] rounded-3xl p-8 sm:p-10">
            <ContactForm />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-[var(--gutter)]">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-white/[0.05]">
          <p className="text-xs text-[#7a7a7a]">
            &copy; <span id="year" /> BenRaff Studio · Tous droits réservés. Séries cinématographiques &amp; visualisation architecturale à Rennes.
          </p>
