...
export const metadata: Metadata = {
  ...
  description:
    'Des projets, pas des rendus. Séries cinématographiques en visualisation architecturale : aménagements extérieurs, intérieurs, équipements publics, paysagisme. BenRaff Studio, Rennes.',
  ...
  openGraph: {
    ...
    images: [{ url: '/projets/pool-house/Vue 2_final.png', width: 1920, height: 1080, alt: 'Séries cinématographiques BenRaff Studio' }],
    locale: 'fr_FR',
    type: 'website',
  },
  twitter: {
...
const jsonLd = {
  ...
  description: 'Séries cinématographiques en visualisation architecturale : extérieurs, intérieurs, équipements publics.',
  url: 'https://benraffstudio.com/projets',
  publisher: {
    '@type': 'LocalBusiness',
    name: 'BenRaff Studio',
  ...
  hasPart: portfolioProjects.map((p) => ({
    '@type': 'CreativeWork',
    name: p.title,
    description: p.intention,
    dateCreated: p.year,
    url: `https://benraffstudio.com/projets/${p.slug}`,
    image: `https://benraffstudio.com${p.image}`,
    genre: p.category,
  })),
}
    ...
    <div className="min-h-screen bg-[#1e1e1e] text-white">
      ...
      <main className="max-w-[1400px] mx-auto px-[var(--gutter)] pt-40 pb-20">
        ...
        <div className="mb-16">
          ...
          <h1 className="mt-4 text-4xl sm:text-6xl font-bold tracking-tight leading-[1.05] text-white mb-6 max-w-[18ch]">
        ...
        <div className="mt-24 pt-16 border-t border-white/[0.06] text-center">
          ...
          <p className="text-[#9a9a9a] text-lg font-light mb-8 max-w-[46ch] mx-auto">
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-white/[0.05]">
            ...
            <nav className="flex items-center gap-5" aria-label="Liens légaux">
              <Link href="/mentions-legales" className="text-xs text-[#7a7a7a] hover:text-[#9a9a9a] transition-colors">Mentions légales</Link>
              <Link href="/politique-de-confidentialite" className="text-xs text-[#7a7a7a] hover:text-[#9a9a9a] transition-colors">Confidentialité</Link>
            </nav>
          </div>
        </div>
      </footer>
