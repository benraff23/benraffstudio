...
export default function LaunchOffer() {
  return (
    <section
      id="offre-lancement"
      className="py-24 sm:py-32 bg-[#080808] relative overflow-hidden"
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-[var(--gutter)] relative">
        ...
        <div className="flex items-center justify-center gap-4 mb-14">
          {[1, 2, 3].map((n) => (
            <div key={n} className="flex flex-col items-center gap-2">
              <div className={`w-10 h-10 rounded-full border flex items-center justify-center text-xs font-semibold
                ${n <= 2
                  ? 'border-white/[0.12] bg-white/[0.04] text-[#5a5a5a] line-through'
          ...
          <div className="h-px w-20 bg-white/[0.06] hidden sm:block" />
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-14">
          {avantages.map(({ num, title, text }) => (
            <div key={num}
                 className="bg-[#111] border border-white/[0.06] rounded-2xl p-7
                            hover:border-white/[0.12] hover:bg-[#161616] transition-all duration-300">
        ...
        <p className="text-center text-xs text-[#5a5a5a] mt-8 max-w-[44ch] mx-auto leading-relaxed">
